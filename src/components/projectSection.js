...
import pentestreport from "../images/NBN PenTest.png"
    ...
    return (
        <div className="projectSection-container">
            ...
            <ProjectSlide index="cardSlide1" 
                    slides={[{img:pentestreport, title:"NBN Pentration Test Report", type:"Course Project", year:"2025", link:"https://drive.google.com/file/d/1wu43MtSB13eZsxCBN3Ea5gy4qINA3A9a/view?usp=sharing", desc:"A pentest performed in a simulated Kali Linux environment, using Nmap, Netcat, Wireshark, OWASP ZAP, cURL, Hydra, Burp Suite, and FTP. The report aims to identify vulnerabilities, assess impact, and recommend mitigation strategies."}, {img:joyeetanweb, title:"Joyee's Portfolio Website", type:"Work Project", year:"2023", link:"https://joyeetanphotography.com/", desc:"A portfolio website I designed and built with Figma and Wordpress for Joyee Tan, a photographer."},{img:notemad, title:"Notemad", type:"Group Project", year:"2022", link:"https://github.com/NotemadOrg/notemad-app", desc:"A web app to help tourists and NYC locals track places they have and haven't visited. I took part building the map tracker with Leaflet API."}, 
